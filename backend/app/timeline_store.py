...
OPS = {
    ...
    "crop_clip": timeline_ops.crop_clip,
    ...
    "set_clip_masks": timeline_ops.set_clip_masks,
    "set_clip_bg_removal": timeline_ops.set_clip_bg_removal,
    "freeze_frame": timeline_ops.freeze_frame,
    "set_clip_beats": timeline_ops.set_clip_beats,
    "set_markers": timeline_ops.set_markers,
    "paste_clip_attributes": timeline_ops.paste_clip_attributes,
    "follow_object": timeline_ops.follow_object,
    "add_sound_design": timeline_ops.add_sound_design,
    "add_adjustment_layer": timeline_ops.add_adjustment_layer,
    "add_cinema_bars": timeline_ops.add_cinema_bars,
    "apply_recipe": timeline_ops.apply_recipe,
