// Controles de síntesis de voz: motor, voz (y mezcla), velocidad, pausa y nombre.
export default function TtsControls({
  engines, engine, setEngine, voices, voice, setVoice, voice2, setVoice2, isKokoro,
  blend, setBlend, speed, setSpeed, pause, setPause, name, setName,
}) {
  return (
